...
public final class BlocksRegistry {
    ...
    private static RegistryObject<Block> RegisterBlocksAndItem(String _name, Supplier<? extends Block> _supplierBlock,  BlockItem.Properties _supplierItem) {
        ...
        ItemRegistry.ITEMS.register(_name, () -> new BlockItem(_block.get(), _supplierItem));
        return _block;
    }
    ...
    public static final RegistryObject<Block> TEST_BLOCK = RegisterBlocksAndItem("test_block", () -> new TestBlock(), new BlockItem.Properties());
